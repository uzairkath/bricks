...
export type FarmCardDataType = {
	title: string;
	icons: Array<string>;
	primaryButtonContent: React.ReactNode;
	primaryButtonDisabled?: boolean;
	primaryButtonHandler: () => Promise<void> | void;
	secondaryButtonContent: React.ReactNode;
	secondaryButtonDisabled?: boolean;
	secondaryButtonHandler: () => Promise<void> | void;
	valueLeft: number;
	valueRight: number;
...
export type FarmCardProps = {
	xDirection?: boolean;
	data: FarmCardDataType;
};

export const FarmCard: React.FC<FarmCardProps> = ({ data }) => {
	const {
		icons,
		title,
		valueLeft,
